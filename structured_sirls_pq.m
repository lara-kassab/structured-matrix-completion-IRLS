...
function [NS, avgerr,avgiterno, TT,timeperiter, TTcpu,Xnew] = structured_sirls_pq(m,n,sr,r,rmax,rknown,eta,gam0,gammin,q,p,tol,nrg,niter,svditer,incr,type,M,Spar)
