...
for k = 1 : numMat
    ...
    for i = 1 : r1
        ...
        for j = 1 : r2
            ...
            errorMatA(i,j) = errorMatA(i,j) + run_sIRLS_q(q,Y_original,M,m,n,r,rknown,2,0);
            
            % Find the error using Structured sIRLS-q,p
            errorMatB(i,j) = errorMatB(i,j) + run_structured_sIRLS(q,p,Y_original,M,m,n,r,rknown, mis_i, mis_j,0);
