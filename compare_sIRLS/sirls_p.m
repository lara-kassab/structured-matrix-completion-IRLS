...
function [NS, avgerr,avgiterno, TT,timeperiter, TTcpu, Xnew] = sirls_p(m,n,sr,r,rmax,rknown,eta,gam0,gammin,p,tol,nrg,niter,svditer,incr,type,M)
...
while(k<niter)
    ...
    [Xnew,err,terr,l] = grad_proj(B,L,Xnew,V,D1,m,n,alpt,betat,2);  
