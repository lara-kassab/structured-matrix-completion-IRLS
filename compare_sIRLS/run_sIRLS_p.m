...
function [error_sIRLS, Xalgo] = run_sIRLS_p(p,Y,M,m,n,r,rknown,type,user)
...
fprintf('\n Algorithm begins...');
fprintf('\n -------------------\n\n');
[NS, avgerr,avgiterno, TT,timeperiter, TTcpu, Xalgo] = sirls_q(m,n,sr,r,rmax,rknown,eta,gam0,gammin,p,tol,nrg,niter,svditer,incr,type,M);
